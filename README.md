![Example-Logo](https://i.imgur.com/Vj48i1m.png)
# Stim Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Stim Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/bNrhnrQ)
***
## Requirements
1) **1,000 STM coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Stim/master/stim_install.sh`
***
...
***Step 2***
* Send EXACLY 1,000 STM to a receive address within your wallet.
***
